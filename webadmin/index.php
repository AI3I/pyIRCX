<?php
/**
 * pyIRCX Web Admin Interface
 * Main administration panel for pyIRCX server
 */
                            ...
                            <h4 style="margin-top: 20px;">Branch Servers (Leaf Nodes)</h4>
                                <div class="form-group">
                                    <div style="background: #e8f4f8; border-left: 4px solid #2196F3; padding: 12px; margin-bottom: 15px; border-radius: 4px;">
                                        <strong>ℹ️ Branch Configuration Generator</strong>
                                        <p style="margin: 8px 0 0 0; font-size: 13px; line-height: 1.6;">
                                            Each entry represents a branch server that connects to this trunk for centralized services.
                                            Click <strong>"📄 Generate Configuration"</strong> to create a complete, deployment-ready configuration file.
                                        </p>
                                        <details style="margin-top: 10px; font-size: 12px;">
                                            <summary style="cursor: pointer; color: #1976D2; font-weight: 500;">▸ Field descriptions (click to expand)</summary>
                                            <ul style="margin: 8px 0 0 20px; line-height: 1.8;">
                                                <li><strong>Branch Server Name</strong> → Unique server identity (configuration: server.name)</li>
                                                <li><strong>Branch Host/IP</strong> → Network address where trunk connects to branch</li>
                                                <li><strong>Linking Port</strong> → Server-to-server communication port (configuration: linking.bind_port)</li>
                                                <li><strong>Link Password</strong> → Shared secret for authentication between servers</li>
                                                <li><strong>SSL Certificate Paths</strong> → Optional custom paths for TLS certificates</li>
                                                <li><strong>Database Filename</strong> → Optional custom database path (auto-generated from branch name)</li>
                                                <li><strong>Client Ports</strong> → Optional custom IRC client ports (inherits from trunk if empty)</li>
                                            </ul>
                                            <p style="margin: 8px 0 0 0; padding: 8px; background: #fff3cd; border-radius: 3px;">
                                                <strong>💡 Configuration Inheritance:</strong> Generated configurations inherit all settings from trunk
                                                (limits, security, servicebot rules) while using branch-specific values for server identity, database,
                                                SSL certificates, and linking parameters. Files are deployment-ready.
                                            </p>
                                        </details>
                                    </div>
