...
# Core IRC Tests
python3 tests/integration/core/users.py      # User management
python3 tests/integration/core/commands.py   # IRC/IRCX commands
python3 tests/integration/core/help.py       # Help system
python3 tests/integration/core/stats.py      # STATS command

# IRCX Extensions
python3 tests/integration/ircx/access.py     # Access control
python3 tests/integration/ircx/services.py   # Service bots

# Staff & Administration
python3 tests/integration/staff/staff.py           # Staff features
python3 tests/integration/staff/authentication.py  # PASS/AUTH/SASL

# Distributed Networking
python3 tests/integration/network/distributed.py   # Cross-server operations
python3 tests/integration/network/topology.py      # Network splits/joins
python3 tests/integration/network/links.py         # Server linking

# Web Integration
python3 tests/integration/web/webchat.py     # WebChat gateway

# Load Testing
python3 tests/integration/load/stress_test.py --quick  # Performance tests
```
...
**Example:**
```bash
python3 tests/integration/core/users.py
```
...
**Example:**
```bash
python3 tests/integration/core/commands.py
```
...
**Example:**
```bash
python3 tests/integration/staff/staff.py
```
...
**Example:**
```bash
python3 tests/integration/ircx/services.py
```
...
**Example:**
```bash
python3 tests/integration/ircx/access.py
```
...
**Example:**
```bash
python3 tests/integration/core/help.py
```
...
**Example:**
```bash
python3 tests/integration/core/stats.py
```
...
**Example:**
```bash
python3 tests/integration/network/distributed.py
```
...
```python
from tests.integration.core.users import IRCTestClient, TestRunner
...
python3 tests/integration/network/distributed.py  # If using server linking
python3 tests/integration/ircx/services.py        # If using services
...
#### `topology.py` - Network Split/Join Tests (15+ tests)
...
**Example:**
```bash
python3 tests/integration/network/topology.py
```
