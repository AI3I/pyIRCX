...
__created__ = "Fri Jan 16 05:44:39 PM EST 2026"
...
RESPONSES = {
    ...
    "867": ":Invalid channel name (must start with # or & and contain only letters, numbers, -, _, or .)",
    "868": ":Invalid nickname (must be 1-{nicklen} characters, start with a letter, and contain only letters, numbers, -, _, [, ], {{, }}, \\, or |)",
    "869": ":Invalid parameter: {param}",
