...
HELP_TOPICS = {
    ...
    "LASTLOGONS": {
        ...
        "lines": [
            ...
            "Usage: /LASTLOGONS [VERBOSE] [filter] [limit]",
            "Show recent connection sessions as a flat table: nickname, username, real name, IP address, logon time, duration, and status.",
            "VERBOSE adds logout time and disconnect reason without changing the default table.",
            ...
            "  /LASTLOGONS VERBOSE alice 25 - Include logout time and disconnect reason",
