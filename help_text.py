...
HELP_TOPICS = {
    ...
    "IRCX": {
        "lines": [
            ...
            "WHISPER #chan nick :message - Private message in channel",
            "DATA #chan id :data - Send structured data to channel",
    ...
    "STAFF": {
        ...
        "lines": [
            ...
            "",
            "Staff Levels:",
            "  ADMIN - Administrator (highest privileges, +a mode)",
            "  SYSOP - System Operator (operator privileges, +o mode)",
            "  GUIDE - Helper/Moderator (helper privileges, +g mode)",
            "",
            "KILL Commands:",
    ...
    "ACCESS": {
        ...
        "staff_lines": [
            ...
            "  Usage: /ACCESS $ <action> [level] [mask] [reason]  (local server)",
            "         /ACCESS * <action> [level] [mask] [reason]  (global network)",
            "  Control server-wide access restrictions",
    ...
    "NOTICE": {
        ...
        "high_staff_lines": [
            "  /NOTICE $ <message> - Server-wide notice (operator/administrator only)",
        ],
        "footer": [
    ...
    "PRIVMSG": {
        ...
        "high_staff_lines": [
            "  /MSG $ <message> - Server-wide message (operator/administrator only)",
        ],
    },
    ...
    "NICK": {
        "lines": [
            ...
            "Examples:",
            "  /NICK alice - Change your nick to alice",
            "Rules: Nicknames must be 1-30 characters, start with a letter, and contain only letters, numbers, -, _, [, ], {, }, \\, or |",
            "Note: You cannot use reserved service names (Registrar, NickServ, etc.)",
        ],
    },
