...
- **44 v2.0.1 Feature Tests** (3 suites) - STATS, HELP, and Services enhancements
...
### v2.0.1 Features (3 suites, 44 tests)
...
7. **tests/integration/help.py** - 15 tests
   - HELP main menu
   - HELP REGISTER (new topic in the current suite)
...
| STATS (v2.0.1) | 16 | All new STATS flags, no-limit fixes |
| HELP (v2.0.1) | 15 | HELP REGISTER, all topics |
| Services (v2.0.1) | 13 | Registrar/ServiceBot improvements |
...
3. **ServiceBot case-insensitive routing** (v2.0.1)
